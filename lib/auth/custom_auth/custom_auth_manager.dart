...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    aspireWalletAuthUserSubject.add(
      AspireWalletAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<AspireWalletAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  AspireWalletAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = AspireWalletAuthUser(
      loggedIn: true,
      uid: authUid,
    );
    aspireWalletAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
...
AspireWalletAuthUser? currentUser;
